                        ...
                        <div class="chooseArea">
                            ...
                            <dl v-for="spu in spuSaleAttrList" :key="spu.id">
                                ...
                                <dd
                                    ...
                                    :key="spuValue.id"
                                    :class="
                                        spuValue.isChecked == 1 ? 'active' : ''
                                    "
                                    @click="changClass(spu, spuValue)">
                        ...
                        <div class="cartWrap">
                            <div class="controls">
                                <input
                                    ...
                                    @input="cartNum" />
                                <a
                                    @click.prevent="addOrMinus(1)"
                                    href="javascript:"
                                    class="plus">
                                    +
                                </a>
                                <a
                                    @click.prevent="addOrMinus(0)"
                                    href="javascript:"
                                    class="mins">
                                    -
                                </a>
                            ...
                            <div class="add">
                                <a
                                    href="javascript:"
                                    @click.prevent="goAddCartSuccess">
                                    加入购物车
                                </a>
                            </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            //动态切换选中的类名
            changClass(spu, spuValue) {
                //传入两个参数，spu，spuValue
                //找到上一个被选中的
                const index = spu.spuSaleAttrValueList.findIndex((ele) => {
                    return ele.isChecked == 1;
                });
                //判断两次选中是否一致，不一致则改变
                if (spuValue.id != spu.spuSaleAttrValueList[index].id) {
                    spu.spuSaleAttrValueList[index].isChecked = 0;
                    spuValue.isChecked = 1;
                }
                //第二种方法;排他
                /* spu.spuSaleAttrValueList.forEach((element) => {
                    element.isChecked = 0;
                });
                spuValue.isChecked = 1; */
            },
            ...
            //购物车的input框手写事件
            cartNum() {
                this.spuNum = +this.spuNum;
                if (isNaN(this.spuNum) || this.spuNum < 1) {
                    this.spuNum = 1;
                }
            },
            //点击购物车跳转
        ...
        mounted() {
            ...
            this.$store.dispatch("detail/getDetailList", skuId);
        },
        computed: {
            ...mapGetters("detail", [
                "categoryView",
